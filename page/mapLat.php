...
<body>
    ...
    <div class="navigation">
        <ul>
            ...
            <li class="list">
                <a href="../authentification/infoclient.php">
                    <span class="icon">
    ...
    <div class="box">
        <div class="form">
            <form action="" method="post">
                ...
                <div class="inputBox">
                    <input type="name" name="latitude" required="required" placeholder="">
                    <span>Latitude</span>
                    <i></i>
                </div>
                <div class="inputBox">
                    <input type="name" name="longitude" required="required" placeholder="">
                    <span>Longitude</span>
                    <i></i>
                </div>
                <div class="links">
                    <a href="mapAddress.php">utiliser votre address</a>
    ...
    if (isset($_POST['envoyer'])) {
        ...
        ?>
        <iframe src="https://maps.google.com/maps?&q=<?php $latitude.','.$longitude; ?> &output=embed " width="100%"
            height="400"></iframe>
