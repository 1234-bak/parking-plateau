...
<body>
    ...
    <div class="box">
        <div class="form">
            <form action="" method="post">
                ...
                <div class="inputBox">
                    <input type="name" name="address" required="required" placeholder="">
                    <span>votre address</span>
                    <i></i>
                </div>
                <div class="links">
                    <a href="MapLat.php">souhaitez vous utilisés votre latitude et longitude ?</a>
    ...
    if (isset($_POST['envoyer'])) {
        ...
        ?>
        <iframe src="https://maps.google.com/maps?&q=<?php echo $addressGPS; ?> &output=embed " width="100%"
            height="400"></iframe>
