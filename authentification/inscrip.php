    ...
    <div class="box">
        <div class="form">
            <form action="" method="post">
                <h2>Inscription</h2>
                <div class="inputBox">
                    <input name="nom" type="text" required="required" placeholder="">
                    <span>nom</span>
                    <i></i>
                </div>
                <div class="inputBox">
                    <input name="prenom" type="text" required="required" placeholder="">
                    <span>prenom</span>
                    <i></i>
                </div>
                <div class="inputBox">
                ...
                <div class="inputBox">
                    <input name="tel" type="number" required="required" placeholder="">
                    <span>Telephone</span>
                    <i></i>
                </div>
                <div class="inputBox">
                ...
                <div class="links">
                    ...
                    <a href="connex.php">se connecter</a>
                </div>
