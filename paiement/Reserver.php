...
<div class="navigation">
    ...
    <div class="container">
        <h1>Où souhaitez vous vous rendre ?</h1>
        <div class="petit_container">
            <div class="class1">
                <img src="./img/plt-nord.png" >
            </div>
            <div class="class2">
                <img src="./img/plt-centre.png" >
            </div>
            <div class="class3">
                <img src="./img/plt-sud.png" >
            </div>
        </div>
        <div class="icon">
            <div>
            ...
            <div>
                <img src="./img/icon_acc.png">
            </div>
            <div>
                <img src="./img/icon_hist.png">
            </div>
        </div>
<?php
